...
class DetalleNuevaSolicitudPage extends StatefulWidget {
  DetalleNuevaSolicitudPage(this.solicitud, {Key key}) : super(key: key);
...
class _DetalleSolicitudPageState extends State<DetalleNuevaSolicitudPage> {
