    ...
    return Row(
      ...
      children: <Widget>[
        Container(
          ...
          child: Container(
            child: Text('Cancelar', textAlign: TextAlign.center,style: styleButton,)
          ),
          ),
        ),
        Container(
          ...
          onPressed: ()=>_submit(),
          child: Container(
            child: Text('Guardar Direccion', textAlign: TextAlign.center,style: styleButton,)
          ),
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: ()async{
                final result = await Navigator.pushNamed(context, 'map',arguments: true);
                if (result!=null) {
                  ...
                  final latlng = LatLng(newUbication.position.latitude,newUbication.position.longitude);
